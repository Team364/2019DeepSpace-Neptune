...
public class TurnToHeading2 extends Command {

    private double wantedHeading;

    public TurnToHeading2(double heading) {
    ...
    protected void execute() {
        //Negated the heading to see if that would make the robot turn in the opposite direction
        //TODO: Test this
