...
public class RobotMap {
    ...
    public static final int l3Hcam = 1000;
    public static final int l3Ccam = 1000;
    ...
    // Closed Loop Targets
    public static final double liftLowH = 14500;// Level 1 for Hatch
    ...
    // Arm PID
    public static final double armPgain = 0.9;
